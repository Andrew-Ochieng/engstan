...
const Whoweare = () => {
    return ( 
        <>
            <div className=" md:px-32 px-6 md:py-16 py-8 grid md:grid-cols-2 gap-8">
                <div className="md:mt-0 mt-4">
                    <img className='rounded-lg' src={kinoti} alt='promotional'/>
                </div>
                <div>
                    <h1 className="content-title">Who We Are</h1>
                    <p className="md:text-lg  text-gray-700 font-light md:leading-loose leading-relaxed">
